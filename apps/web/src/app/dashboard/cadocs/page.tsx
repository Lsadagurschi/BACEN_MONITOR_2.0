...
export default function CadocsPage(){
  ...
  const[result,setResult]=useState<{erros:ValErr[],content:string,filename:string,txts?:Record<string,string>}|null>(null)
  const[parseErr,setParseErr]=useState('')
  const[resTab,setResTab]=useState<'resumo'|'erros'|'preview'|'rules'>('resumo')
